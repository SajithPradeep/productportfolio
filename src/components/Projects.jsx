  ...
  return (
    <div className="accordion-item">
      <div className="accordion-title" onClick={toggleAccordion}>
        ...
        <div className="seeDetails-responsive">
...
const Projects = () => {
  ...
  const tabs = [
    ...
    { id: 'wd', label: 'Frontend Developer' },
    { id: 'pp', label: 'Personal Projects' }
  ];
        ...
        <div className="tab-content">
          ...
          {activeTab === 'wd' && (
            <div className="accordion">
              ...
              <ProjectAccordionItem title="Order fulfillment web portal for UK based retail chain" orgDate="Frontend Dev, Coffeebeans Consulting">
                <ul>
          ...
          {activeTab === 'pp' && (
            <div className="accordion">
              <ProjectAccordionItem title="Portfolio Website" orgDate="Personal Project">
                <ul>
                  <li>Designed and developed a personal portfolio website using React.js to showcase my projects and skills.</li>
                  <li>Implemented responsive design principles to ensure optimal viewing across various devices.</li>
                  <li>Utilized modern React hooks and best practices for efficient state management and component structure.</li>
                </ul>
              </ProjectAccordionItem>
